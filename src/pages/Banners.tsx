      ...
      <main className="container mx-auto py-12 px-4">
        <section className="bg-white shadow-lg rounded-lg p-8">
          ...
          <p className="text-gray-600 mb-6">
            Our banner design and printing services are perfect for advertising
            your business, event, or special promotions. We offer customizable
            banners that help you grab attention and communicate your message
            effectively.
          </p>
          <p className="text-gray-600">
            Whether you're promoting a sale, event, or new product, our team is
            here to deliver high-quality banners that help you stand out.
          </p>
        </section>
      </main>
