      ...
      <main className="container mx-auto py-12 px-4">
        <section className="bg-white shadow-lg rounded-lg p-8">
          ...
          <p className="text-gray-600 mb-6">
            Our brochure design and printing services offer a professional and
            impactful way to showcase your products or services. We provide
            high-quality materials and customizable designs to ensure your
            brochure effectively communicates your message.
          </p>
          <p className="text-gray-600">
            Whether you're promoting a new product, event, or service, our team
            is dedicated to delivering brochures that make a lasting impression.
          </p>
        </section>
      </main>
