      ...
      <main className="container mx-auto py-12 px-4">
        <section className="bg-white shadow-lg rounded-lg p-8">
          ...
          <p className="text-gray-600 mb-6">
            Our packaging design and production services are designed to help
            your products stand out on the shelf. We focus on providing
            functional, visually appealing packaging that enhances the overall
            customer experience.
          </p>
          <p className="text-gray-600">
            From concept to production, our team ensures that your packaging
            aligns with your brand and protects your products throughout their
            journey.
          </p>
        </section>
      </main>
