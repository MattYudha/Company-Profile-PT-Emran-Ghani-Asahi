      ...
      <main className="container mx-auto py-12 px-4">
        <section className="bg-white shadow-lg rounded-lg p-8">
          ...
          <p className="text-gray-600 mb-6">
            Our logo design services focus on creating a strong visual identity
            for your brand. We offer custom logo designs that reflect your
            company’s values, mission, and personality.
          </p>
          <p className="text-gray-600">
            Whether you're starting a new business or rebranding, our team is
            here to craft a logo that makes a lasting impression.
          </p>
        </section>
      </main>
