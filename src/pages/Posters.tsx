    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto py-12 px-4">
        <section className="bg-white shadow-lg rounded-lg p-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Posters</h2>
          <p className="text-gray-600 mb-6">
            Our poster design and printing services are perfect for making a
            statement with large-format prints. Whether you're advertising a
            product, event, or a cause, we provide high-quality materials that
            grab attention.
          </p>
          <p className="text-gray-600">
            Our team is dedicated to delivering posters that not only meet your
            expectations but also stand out from the crowd.
          </p>
        </section>
      </main>
